...
def load_data():
    ...
    # اگر فایل در مسیر اصلی پیدا نشد، مسیر فعلی اسکریپت را بررسی می‌کنیم
    # این کار باعث انعطاف‌پذیری بیشتر در استقرار می‌شود
    if not os.path.exists(json_path):
        ...
        if os.path.exists(alt_path):
            ...
            # در نهایت اگر هنوز پیدا نشد، خطا می‌دهیم
            raise HTTPException(
                status_code=500,
                detail=f"MData_Cleaned.json not found at: {base_dir} or {alt_dir}"
            )
